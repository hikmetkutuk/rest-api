...
router.post('/api/add-product', [auth_1.checkJwt, auth_1.checkRole(['admin'])], productController.store);
router.put('/api/edit-product/:id', [auth_1.checkJwt, auth_1.checkRole(['admin'])], productController.update);
router.delete('/api/delete-product/:id', [auth_1.checkJwt, auth_1.checkRole(['admin'])], productController.destroy);
